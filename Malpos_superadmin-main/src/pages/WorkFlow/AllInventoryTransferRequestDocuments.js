...
// export default function AllInventoryTransferRequestDocuments() {
...
//         axios.get(`${BASE_URL}/api/pendinggoodissue?CompanyDB=${companyDB}`),
//         axios.get(`${BASE_URL}/api/Inventory-Close-Req?CompanyDB=${companyDB}`)
//       ]);
...
//                 </select>
//               </Col>
//              {/* <Col xs={12} sm={6} md={4} style={{paddingLeft:"20%" }} >
//                <Link to="/inventory">
...
// // Sort by DocNum in descending order
// combined.sort((a, b) => Number(b.DocNum) - Number(a.DocNum));

// setInventoryRequest(combined);
// console.log("Sorted DocNums:", combined.map(i => i.DocNum));
...
//                           <tr className="" style={{ backgroundColor: "#f8f9fa" }}>
//                               {/* <td>{(currentPage - 1) * perPage + index + 1}</td> */}
//                             <td>
//                               <FontAwesomeIcon
//                                 icon={
...
//                                 onClick={() => toggleExpand(doc.DocNum)}
//                               />
//                             </td>
...
//                               <span
//                                 className={`badge ${
//                                   doc.Status === "Open" ? "bg-success" : "bg-secondary"
//                                 }`}
//                                 style={{ fontSize: "0.85rem" }}
//                               >
//                                 {doc.Status}
