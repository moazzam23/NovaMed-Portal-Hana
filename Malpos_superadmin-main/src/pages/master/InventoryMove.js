          ...
          <form onSubmit={handleSubmit}>
            <Row>
              ...
              <Col md={12} style={{marginBottom:"70px"}} >
                  <h2 style={{fontWeight:"400",textAlign:"left"}}>Create Inventory Transfer Request</h2>
              </Col>
              <Col md={12}>
<Row className="mb-3">
  ...
  <Table responsive bordered hover className="premium-table align-middle text-center"    style={{ tableLayout: "fixed", minWidth: "2100px" }}>
      <thead className=" " style={{fontSize:"13px"}}  >
                      <tr >
                        ...
                        <th style={{width:"300px" , paddingLeft:"30px"}}>Item Name</th>
                        ...
                        <th style={{paddingLeft:"50px",textAlign:"left"}} >Action</th> 
                      </tr>
                    </thead>
